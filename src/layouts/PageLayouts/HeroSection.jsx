          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-[360px] h-[440px] flex items-center justify-center">
              ...
              <div className="absolute inset-0 pointer-events-none">
                {/* Primary glow - large and diffused */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[320px] h-[320px] bg-primary-500/[0.08] blur-[100px] rounded-full" />
                {/* Secondary glow - offset, morphing */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] h-[250px] bg-violet-500/[0.06] blur-[80px] rounded-full animate-morph" />
                {/* Accent glow - small, intense */}
                <div className="absolute top-[30%] left-[60%] w-[120px] h-[120px] bg-cyan-400/[0.04] blur-[50px] rounded-full animate-blob" />
              </div>
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none">
                {/* Outer ring - dashed */}
                <div
                  className="absolute w-[340px] h-[340px] rounded-full border border-dashed border-white/[0.04] animate-orbit"
                  style={{ marginLeft: "-170px", marginTop: "-170px" }}
                />
                {/* Middle ring - solid subtle */}
                <div
                  className="absolute w-[280px] h-[280px] rounded-full border border-white/[0.06] animate-orbit-reverse"
                  style={{ marginLeft: "-140px", marginTop: "-140px" }}
                />
                {/* Inner ring - gradient effect */}
                <div
                  className="absolute w-[220px] h-[220px] rounded-full animate-orbit"
                  style={{
                    marginLeft: "-110px",
                    marginTop: "-110px",
                    background:
                      "conic-gradient(from 0deg, transparent 0%, rgba(99,102,241,0.1) 25%, transparent 50%, rgba(139,92,246,0.08) 75%, transparent 100%)",
